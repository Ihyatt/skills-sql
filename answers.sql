...
select models.name, models.brand_name, headquarters from models join brands on models.brand_name = brands.name where models.name = 'Mustang';
...
select models.name, models.brand_name, brands.founded from models left join brands on brands.name = models.brand_name where models.year = 1960;
...
select brands.name, brands.founded, models.name from brands left join models on brands.name = models.brand_name where brands.discontinued IS NULL;
...
select models.name, models.brand_name, brands.founded from brands join models on brands.name = models.brand_name;
...
select brands.name, founded from brands left join models on brands.name = models.brand_name where models.brand_name IS NULL;